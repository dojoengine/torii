...
impl Runner {
    ...
    pub async fn run(mut self) -> anyhow::Result<()> {
        ...
        options = options.pragma("soft_heap_limit", self.args.sql.soft_memory_limit.to_string());
        options = options.pragma("hard_heap_limit", self.args.sql.hard_memory_limit.to_string());
