...
use torii_proto::{
    ...
    Page, Query, Token, TokenBalance, TokenBalanceQuery, TokenCollection, TokenContract,
    TokenContractQuery, TokenQuery, TokenTransfer, TokenTransferQuery, Transaction, TransactionCall,
    TransactionQuery,
};
