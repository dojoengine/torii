...
pub(crate) static WEBSOCKET_PROXY_CLIENT: std::sync::LazyLock<ReverseProxy<HttpConnector<GaiResolver>>> = std::sync::LazyLock::new(|| {
    ReverseProxy::new(
        Client::builder()
         .build_http(),
    )
...
pub(crate) static PROXY_CLIENT: std::sync::LazyLock<ReverseProxy<HttpConnector<GaiResolver>>> = std::sync::LazyLock::new(|| {
    ReverseProxy::new(
        Client::builder()
         .http2_only(true)
         .build_http(),
