...
pub static ENTITY_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
...
pub static EVENT_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
    (Name::new("keys"), TypeData::Simple(TypeRef::named_list(TypeRef::STRING))),
...
pub static MODEL_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
...
pub static CALL_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("transactionHash"), TypeData::Simple(TypeRef::named(TypeRef::STRING))),
...
pub static TRANSACTION_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
    (
        Name::new("transactionHash"),
        TypeData::Simple(TypeRef::named(Primitive::Felt252(None).to_string()))
...
pub static PAGE_INFO_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| TypeMapping::from([
...
pub static SOCIAL_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("name"), TypeData::Simple(TypeRef::named(TypeRef::STRING))),
    (Name::new("url"), TypeData::Simple(TypeRef::named(TypeRef::STRING))),
]));

pub static CONTENT_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("name"), TypeData::Simple(TypeRef::named(TypeRef::STRING))),
...
pub static METADATA_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
...
pub static TOKEN_BALANCE_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("tokenMetadata"), TypeData::Nested((TypeRef::named_nn(TOKEN_UNION_TYPE_NAME), IndexMap::new()))),
]));

pub static TOKEN_TRANSFER_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
...
pub static ERC20_TOKEN_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
...
pub static ERC721_TOKEN_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("name"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
    (Name::new("symbol"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
...
pub static ERC1155_TOKEN_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("name"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
    (Name::new("symbol"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
    (Name::new("tokenId"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
    (Name::new("contractAddress"), TypeData::Simple(TypeRef::named_nn(TypeRef::STRING))),
...
pub static EMPTY_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
]));

pub static CONTROLLER_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("id"), TypeData::Simple(TypeRef::named(TypeRef::ID))),
...
pub static TOKEN_TYPE_MAPPING: LazyLock<TypeMapping> = LazyLock::new(|| IndexMap::from([
    (Name::new("tokenMetadata"), TypeData::Nested((TypeRef::named_nn(TOKEN_UNION_TYPE_NAME), IndexMap::new()))),
]));
